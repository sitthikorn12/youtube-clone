...
const Card8 = ({ type }) => {
  return (
    <Link to="/video8/test" style={{ textDecoration: "none" }}>
      <Container type={type}>
        <Image
          type={type}
          src="https://photo-cms-vovworld.zadn.vn/w500/uploaded/vovworld/wsxrxqeiod/2022_04_10/5_ywfm_hagn.jpg"
        />
        <Details type={type}>
          <ChannelImage
            type={type}
          ...
          <Texts>
            ...
            <Info>10 views • 1 minute ago</Info>
          </Texts>
        </Details>
      </Container>
    </Link>
