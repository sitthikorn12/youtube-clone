...
const Card2 = ({ type }) => {
  return (
    <Link to="/video2/test" style={{ textDecoration: "none" }}>
      <Container type={type}>
        <Image
          type={type}
          src="https://p4.wallpaperbetter.com/wallpaper/487/528/965/beautiful-nature-view-waterfalls-and-mountains-wallpaper-preview.jpg"
        />
        <Details type={type}>
          <ChannelImage
            type={type}
          ...
          <Texts>
            ...
            <Info>800 views • 99 day ago</Info>
          </Texts>
        </Details>
      </Container>
    </Link>
