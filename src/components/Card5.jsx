...
const Card5 = ({ type }) => {
  return (
    <Link to="/video5/test" style={{ textDecoration: "none" }}>
      <Container type={type}>
        <Image
          type={type}
          src="https://vsegda-pomnim.com/uploads/posts/2022-04/1649136226_1-vsegda-pomnim-com-p-priroda-foto-2.jpg"
        />
        <Details type={type}>
          <ChannelImage
            type={type}
          ...
          <Texts>
            ...
            <Info>1 views • 1,000 years ago</Info>
          </Texts>
        </Details>
      </Container>
    </Link>
